...
class FaradayEfficiency(BaseModel):
    ...
    def calculate_faraday_efficiencies(self, gc_measurement: Measurement):
        """
        This function uses the injection time  as well as the assigned peak areas of the given GC measurement to compute the Faraday effiency.
    ...
    #     # input
    #     # adjusted flow rate of total volume flow, o-xylene
    #     # mass of used cat
    #     # gc peak areas (8 different species)
    #     # reactor temperature
    #     # pressure
    #     # CO2 and CO volume fractions in % (from IR photometer)
    #     # response factors

    #     modified_residence_time: float = None
    #     selectivity: float = None
    #     conversion_rate: float = None

    #     modified_residence_time = (mass_cat * T_0 * p_reac) / (
    #         total_volume_flow * T_reac * p_0
    #     )  # T_0 = 273.15 K, p_0 = 1 atm
    #     average_peak_area_bypass = average(peak_area_bypass_i)
    #     conversion_rate_ox = 1 - (peak_area_ox_i / peak_area_bypass_ox_0)
    #     peak_area_ij = (
    #         peak_area_ij * response_factor_i / (average_peak_area_bypass - peak_area_ij)
    #     )
    #     selectivity_CO2 = volume_fraction_CO2 / (
    #         conversion_rate_ox * 8 * volume_fraction_ox
    #     )

    #     selectivity_for_total_oxidation = selectivity_CO2 + selectivity_CO

    #     selectivity = (peak_area_ij / peak_area_ox) / (
    #         conversion_rate_ij / conversion_rate_ox
    #     )

    #     # output
    #     # selectivity against conversion rate of o-xylene
    #     # conversion rate of o-xylene against modified residence time
