...
@forge_signature
class GeneralInformation(sdRDM.DataModel, search_mode="unordered"):
    ...
    scenario_name: Optional[str] = element(
        default=None, tag="scenario_name", json_schema_extra=dict()
    )
    ...
    def add_to_experiments(
        ...
        **kwargs
        ...
        Args:
            ...
            tag (): name tag for an experiment. Unique within the namespace of one dataset.. Defaults to None
